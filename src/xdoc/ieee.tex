...
\tt @index defn {\it ident}&The current chunk contains a definition of {\it ident}\\
\tt @index use {\it ident}&The current chunk contains a use of {\it ident}\\
\tt @index nl {\it ident}&A newline that is part of markup, not part of the chunk\\
...
\end{tabular}}
\end{quote}
where {\it codeline} may be {\tt @text}, {\tt @nl}, {\tt @use}, or
{\tt @index}.
